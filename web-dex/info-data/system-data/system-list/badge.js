const badgeData = {
  ...
  description: `
The **Badge** is a transformation device used in the *CreatureMatsu* universe. It was developed by **Dr. Leezar** as part of his early genetic experiments with the Sextuplets known as the **Matsu**. The badge allows a Matsu to temporarily transform into a creature form with altered biology, abilities, and behavior. The device functions as the activation trigger for the transformation system known as **Syndata**.
`,
...
`
    ...
    {
      title: "Statement from Dr. Leezar",
      text: `
<p>Dr. Leezar often uses the word **“Badge”** in everyday speech, as it sounds informal and familiar when referring to the creatures. In professional or scientific contexts, he uses the more precise term **“Transformation Badge.”**</p>
`
    },
        {
      title: "Early Laboratory Version",
      text: `
<p>In the earliest stage of Dr. Leezar’s experiments, the badges used in the laboratory were **short cylindrical devices** that could be manually activated by the scientist.</p>

<p>These early badges were used during the creation of the creatures belonging to the **First Pillar: Origins**. The technology was still experimental at that time and was part of the initial engineering challenge of modifying the Matsu bodies.</p>
`
    },
        {
      title: "Appearance",
...
`
      ...
      {
      title: "Connection to Syndata",
      text: `
      <p>The **Badge** is closely linked to a system called **Syndata**, a special mechanism capable of altering the mental state and biological configuration of a Matsu.</p>
[md]
**INPUT:** Matsu  
--> **TRIGGER:** Badge Activation  
--> **SYSTEM:** Syndata  
...
`
      ...
      text: `
<p>The creature transformation triggered by a Badge is not permanent. Once the Syndata system activates, the Matsu enters a creature form that remains stable for a limited period of time.</p>

<p>The active duration usually lasts about **one and a half days**. After this period, the transformation naturally ends and the Matsu automatically returns to his base form.</p>

<p>This limitation exists because the Syndata process temporarily restructures the biological and mental state of the Matsu. Maintaining the altered state for longer periods would destabilize the system, so the transformation gradually deactivates on its own.</p>
...
[img]info-data/system-data/system-images/badge-transform-b.png[/img]
`
    },
