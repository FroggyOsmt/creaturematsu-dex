...
body.innerHTML = `
  <div class="extra-image-slider" id="extraImageSlider">
    ${images.map(src => `
        ...
        <img src="info-data/extra-data/extra-image/action/${src}" class="extra-popup-image">
      </div>
    `).join("")}
  </div>
...
if (type === "SHEET") {
  ...
  body.innerHTML = `
    <div class="extra-image-slider" id="extraImageSlider">
      ${images.map(item => `
        <div class="extra-image-slide">
          <img src="info-data/extra-data/extra-image/sheet/${item.src}" class="extra-popup-image">
        </div>
      `).join("")}
    </div>
